...
const WEATHER_API_URL = 'https://api.open-meteo.com/v1/forecast?latitude=51.5074&longitude=-0.1278&current=temperature_2m,relative_humidity_2m,wind_speed_10m';
...
const server = http.createServer(async (req, res) => {
  ...
  try {
    ...
    const htmlOutput = `
      ...
      <html>
        <head>
          <title>Real-Time London Weather</title>
          <style>
